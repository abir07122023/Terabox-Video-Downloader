"""
╔══════════════════════════════════════════════════════════════════╗
║          TERABOX TELEGRAM BOT — WORKING (PUBLIC API)             ║
║          Uses https://terabox.howdownload.com/api               ║
...
# ================== TERABOX DOWNLOAD (PUBLIC API) ==================
async def download_terabox_video(share_url: str) -> Optional[str]:
    """Use public API (no cookie, no token) to get direct download link."""
...
def main():
    ...
    # Delete webhook once to avoid conflict (run_polling will manage its own event loop)
